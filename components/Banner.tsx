  ...
  return (
    <section className="relative overflow-hidden bg-zinc-950 text-zinc-100">
      ...
      <div className="relative mx-auto w-full px-4 sm:px-6 lg:w-2/3 lg:px-0">
        <div className="grid gap-10 py-12 lg:grid-cols-12 lg:gap-12 lg:py-20">
          {/* Left: Hero text */}
          <div className="rise-in flex flex-col justify-center lg:col-span-7">
            ...
            <h1 className="mt-6 text-[36px] font-bold leading-[1.1] tracking-tight sm:text-[48px] lg:text-[60px]">
              Mua sắm thông minh,{" "}
          ...
          {/* Right: Banner carousel or showcase */}
        ...
        {/* Trust badges */}
        <div className="grid grid-cols-2 gap-3 border-t border-zinc-800 py-6 sm:grid-cols-3">
          {[
